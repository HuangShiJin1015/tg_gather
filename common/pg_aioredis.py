...
class Client:
    ...
    def __init__(self, host='localhost', password=None, port=6379, loop=None, encoding='utf-8'):
        self.host = host
    ...
    def incr(self, key, amount=1):
        return self._client.incrby(key, increment=amount)

    def expire(self, key, ex=24 * 60 * 60):
        return self._client.expire(key, ex)
